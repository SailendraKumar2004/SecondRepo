...
pdf_path = "D:\\all files\\Academics And Skills\\B.TECH\\2ND Year\\internship at IIIT H\\text extraction form pdf\\Re_ Selenium Resources and Site Links\\40179_2013_3_1501_21150_Judgement_05-Mar-2020_MAR.pdf"
...
with open('3_pdfMinerText(a).txt', 'w', encoding='utf-8') as txt_file:
...
# # Save the document
# doc.save('3_pdfMinerText(a).docx')
