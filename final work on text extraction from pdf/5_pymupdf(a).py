...
pdf_path = r"D:\all files\Academics And Skills\B.TECH\2ND Year\internship at IIIT H\text extraction form pdf\Re_ Selenium Resources and Site Links\KACD310009972023_1_2024-04-15.pdf"
pdf = fitz.open(pdf_path)

# Open a text file for writing
with open('5_pymupdf(a).txt', 'w', encoding='utf-8') as txt_file:
