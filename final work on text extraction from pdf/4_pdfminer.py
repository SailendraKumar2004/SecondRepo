...
pdf_path = "D:\\all files\\Academics And Skills\\B.TECH\\2ND Year\\internship at IIIT H\\text extraction form pdf\\Re_ Selenium Resources and Site Links\\Deposition Tiruvarur TNTV040000392022_5_2024-04-16.pdf"
...
with open('4_pdfMinerText(a).txt', 'w', encoding='utf-8') as txt_file:
...
# # Save the document
# doc.save('4_pdfMinerText(a).docx')
